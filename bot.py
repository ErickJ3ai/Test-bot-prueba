...
        await ctx.followup.send("¡Ya tienes una partida en curso! Intenta adivinar la palabra.", ephemeral=True)
        return
...
        # Lógica para descontar rondas solo en intentos de palabra completa
        if len(guess) > 1 and guess != game['word']:
            game['rounds'] -= 1
            if game['rounds'] > 0:
